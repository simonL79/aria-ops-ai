...
import { Search, Bot, Database, Globe, ArrowLeft } from 'lucide-react';
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl text-gray-300">
                Intelligent web scraping and data collection
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Card className="bg-[#111214] border-gray-800 hover:border-amber-600/50 transition-colors">
              ...
              <CardContent>
                <div className="text-3xl font-bold text-amber-400">1.2M</div>
            ...
            <Card className="bg-[#111214] border-gray-800 hover:border-amber-600/50 transition-colors">
              ...
              <CardContent>
                ...
                <p className="text-sm text-gray-400">Websites tracked</p>
              </CardContent>
            </Card>
          </div>
        </div>
