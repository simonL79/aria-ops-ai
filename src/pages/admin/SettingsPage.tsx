...
const SettingsPage = () => {
  return (
    <DashboardLayout>
      <Helmet>
        <title>A.R.I.A™ Settings - System Configuration</title>
        <meta name="description" content="System settings and configuration management" />
      </Helmet>
        ...
        <Tabs defaultValue="general" className="space-y-4">
          ...
          <TabsContent value="database" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">Configure database connections and performance settings.</p>
              </CardContent>
            </Card>
          </TabsContent>
          ...
          <TabsContent value="notifications" className="space-y-4">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">Configure notification preferences and alert settings.</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
