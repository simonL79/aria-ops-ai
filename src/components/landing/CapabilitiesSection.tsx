  ...
  return (
    <section className="py-24 px-6 bg-[#D8DEE9]">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black text-center mb-6 text-[#0A0F2C] font-['Space_Grotesk'] tracking-tight px-4 mx-auto max-w-5xl">
              ...
              <div className="relative p-6 sm:p-8 md:p-10 text-center">
                <div className="flex flex-col items-center mb-6">
                  <div className={`p-3 rounded-2xl bg-gradient-to-r ${capability.gradient} shadow-lg group-hover:shadow-[0_0_20px_rgba(36,124,255,0.3)] mb-4`}>
                    <Check className="h-6 sm:h-7 w-6 sm:w-7 text-white" />
                  </div>
                  <h3 className="font-bold text-base sm:text-lg md:text-xl text-[#0A0F2C] group-hover:text-white transition-colors font-['Space_Grotesk'] tracking-wide text-center px-2">
                    {capability.title.toUpperCase()}
                  </h3>
                </div>
                <p className="text-sm sm:text-base text-[#1C1C1E] group-hover:text-[#D8DEE9] transition-colors leading-relaxed font-['Inter'] text-center">
