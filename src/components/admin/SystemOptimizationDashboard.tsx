...
import LiveDataIntegrityPanel from './LiveDataIntegrityPanel';
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="grid w-full grid-cols-3 bg-corporate-darkSecondary border border-corporate-border">
          <TabsTrigger value="overview" className="data-[state=active]:bg-corporate-accent data-[state=active]:text-black text-corporate-lightGray">
            System Overview
          </TabsTrigger>
          <TabsTrigger value="integrity" className="data-[state=active]:bg-corporate-accent data-[state=active]:text-black text-corporate-lightGray">
            🔥 Live Data Integrity
          </TabsTrigger>
          <TabsTrigger value="optimization" className="data-[state=active]:bg-corporate-accent data-[state=active]:text-black text-corporate-lightGray">
