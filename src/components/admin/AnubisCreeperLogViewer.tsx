        ...
        <CardContent className="space-y-6">
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">
              Creeper Agent Retired
            </h3>
            <p className="text-gray-400 max-w-md mx-auto">
              The Anubis Creeper monitoring agent has been retired. Advanced threat monitoring 
              is now handled by the Genesis Sentinel early warning system.
            </p>
          </div>
          ...
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-blue-400 font-medium mb-1">Enhanced Monitoring Available</h4>
                  <p className="text-sm text-gray-300">
                    Access advanced threat detection and monitoring through Genesis Sentinel.
                  </p>
                </div>
              </div>
              <Button
