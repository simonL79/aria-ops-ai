...
const EnhancedCTASection = () => {
  return (
    <section id="enhanced-cta" className="py-24 text-center bg-gradient-to-r from-premium-black to-premium-darkGray text-foreground">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl md:text-5xl font-bold mb-6 text-shadow">Take Control of Your Online Reputation Today</h2>
        <p className="text-lg md:text-xl mb-12 max-w-2xl mx-auto text-foreground">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold mb-2 text-foreground">Request Your Scan</h3>
            <p className="text-foreground mb-4">Get a comprehensive analysis of your current online presence.</p>
            <Button asChild variant="outline" className="mt-auto border-white text-foreground hover:bg-white hover:text-premium-darkGray">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center text-center">
            <div className="bg-blue-600 rounded-full w-12 h-12 flex items-center justify-center mb-4">
              <span className="text-foreground font-bold text-lg">2</span>
            </div>
            <h3 className="text-xl font-bold mb-2 text-foreground">Review Your Report</h3>
            <p className="text-foreground mb-4">Understand your risks and opportunities with our detailed analysis.</p>
            <Button asChild variant="outline" className="mt-auto border-white text-foreground hover:bg-white hover:text-premium-darkGray">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center text-center">
            <div className="bg-blue-600 rounded-full w-12 h-12 flex items-center justify-center mb-4">
              <span className="text-foreground font-bold text-lg">3</span>
            </div>
            <h3 className="text-xl font-bold mb-2 text-foreground">Take Action</h3>
            <p className="text-foreground mb-4">Implement our recommendations or let us handle it for you.</p>
            <Button asChild variant="outline" className="mt-auto border-white text-foreground hover:bg-white hover:text-premium-darkGray">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 mt-8">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-foreground">Free initial scan</span>
            </div>
            <div className="flex items-center gap-2 text-sm">
              <Check className="h-5 w-5 text-green-400" />
            ...
            <div className="flex items-center gap-2 text-sm">
              <Check className="h-5 w-5 text-green-400" />
              <span className="text-foreground">Expert recommendations</span>
            </div>
          </div>
          
          <div className="inline-block mt-8">
            <Button asChild variant="link" className="text-foreground hover:text-foreground">
