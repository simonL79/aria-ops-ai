      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <h3 className="text-xl font-bold mb-2">Request Your Scan</h3>
            <p className="text-premium-silver mb-4">Get a comprehensive analysis of your current online presence.</p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <p className="text-premium-silver mb-4">Understand your risks and opportunities with our detailed analysis.</p>
            <Button asChild variant="outline" className="mt-auto border-white text-white hover:bg-white hover:text-premium-darkGray">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 flex flex-col items-center text-center">
            ...
            <p className="text-premium-silver mb-4">Implement our recommendations or let us handle it for you.</p>
            <Button asChild variant="outline" className="mt-auto border-white text-white hover:bg-white hover:text-premium-darkGray">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm text-premium-silver mt-4">
          ...
          <div className="inline-block mt-8">
            <Button asChild variant="link" className="text-premium-silver hover:text-white">
