...
const HeroSection = () => {
  return (
    <section className="hero bg-background text-foreground py-20 relative overflow-hidden min-h-screen flex items-center">
      <div className="container mx-auto px-6 relative z-10 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
          <div className="space-y-8">
            ...
            <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 inline-flex items-center gap-2">
