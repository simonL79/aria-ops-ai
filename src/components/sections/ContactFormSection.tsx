        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="glass-card p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <label className="text-foreground text-sm font-medium mb-2 block">Company Email *</label>
                <Input
                  name="companyEmail"
                  type="email"
              ...
              <div>
                <label className="text-foreground text-sm font-medium mb-2 block">Brief Details *</label>
                <Textarea
                  name="details"
