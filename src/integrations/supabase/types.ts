...
export type Database = {
  ...
  public: {
    Tables: {
      _archived_anubis_entity_memory: {
        Row: {
          content: string | null
          created_at: string
      ...
      _archived_eris_attack_simulations: {
        Row: {
      ...
      _archived_eris_response_strategies: {
        Row: {
          created_at: string
      ...
      _archived_graveyard_simulations: {
        Row: {
          created_at: string
      ...
      _archived_multilingual_threats: {
        Row: {
          content: string | null
          created_at: string
      ...
      _archived_persona_saturation_campaigns: {
        Row: {
      ...
      _archived_sentience_memory_log: {
        Row: {
          context: string | null
          created_at: string
      ...
      _archived_sentience_recalibration_decisions: {
        Row: {
      ...
      eidetic_notification_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "eidetic_notification_log_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "eidetic_resurfacing_events"
            referencedColumns: ["id"]
      ...
      requiem_serp_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "requiem_serp_snapshots_job_id_fkey"
            columns: ["job_id"]
            isOneToOne: false
            referencedRelation: "requiem_jobs"
            referencedColumns: ["id"]
      ...
      shield_intake_upload_rate_limits: {
        Row: {
          created_at: string
          id: string
          ip_hash: string
